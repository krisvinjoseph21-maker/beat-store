                ...
                <>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted mt-0.5 ml-4">
                      ...
                      {beat.file_path && !beat.mp3_path && <span className="ml-2 text-amber-500">· no mp3 yet</span>}
                    </p>
                  </div>
                  ...
                  {mpEditId === pack.id ? (
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <button type="button" onClick={() => mpEditCoverRef.current?.click()} className="w-full cursor-pointer rounded-lg border border-dashed border-line-input px-3 py-2 text-center hover:border-muted">
                      ...
                      <div>
                        ...
                        <button type="button" onClick={() => mpEditFileRef.current?.click()} className="w-full cursor-pointer rounded-lg border border-dashed border-line-input px-3 py-2 text-center hover:border-muted">
                ...
                <div key={pack.id} className="rounded-xl border border-line-card bg-surface-1 px-4 py-3">
                  {dpEditId === pack.id ? (
                    <div className="space-y-3">
                      ...
                      <div>
                        <label className="block text-[10px] text-muted mb-1">Cover Image</label>
                        <button type="button" onClick={() => dpEditCoverRef.current?.click()} className="w-full cursor-pointer rounded-lg border border-dashed border-line-input px-3 py-2 text-center hover:border-muted">
                      ...
                      <div>
                        <label className="block text-[10px] text-muted mb-1">Pack File (ZIP)</label>
                        <button type="button" onClick={() => dpEditFileRef.current?.click()} className="w-full cursor-pointer rounded-lg border border-dashed border-line-input px-3 py-2 text-center hover:border-muted">
