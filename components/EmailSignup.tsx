  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-md flex flex-col gap-3">
      <div className="flex gap-2">
        ...
        <button
          type="submit"
          className="flex-shrink-0 inline-flex items-center gap-2 rounded-sm bg-white px-6 py-3.5 text-sm font-black text-black hover:bg-zinc-100 transition-colors"
        >
