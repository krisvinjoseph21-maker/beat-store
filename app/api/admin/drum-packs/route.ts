...
export async function GET(req: NextRequest) {
  ...
  if (error) {
    console.error('[admin/drum-packs GET]', error)
    return Response.json({ error: 'Failed to fetch drum packs' }, { status: 500 })
  }
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (error) {
      console.error('[admin/drum-packs POST]', error)
      return Response.json({ error: 'Failed to create drum pack' }, { status: 500 })
    }
    return Response.json(data)
  } catch {
...
export async function PATCH(req: NextRequest) {
  ...
  try {
    ...
    if (error) {
      console.error('[admin/drum-packs PATCH]', error)
      return Response.json({ error: 'Failed to update drum pack' }, { status: 500 })
    }
    return Response.json(data)
  } catch {
    return Response.json({ error: 'Invalid request' }, { status: 400 })
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    const { error } = await supabase.from('drum_packs').delete().eq('id', id)
    if (error) {
      console.error('[admin/drum-packs DELETE]', error)
      return Response.json({ error: 'Failed to delete drum pack' }, { status: 500 })
    }
