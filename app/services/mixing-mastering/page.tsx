...
export const metadata: Metadata = {
  title: 'Mixing & Mastering — KJYOUCRAZY',
  description: 'Professional mixing and mastering services from KJYOUCRAZY. 48-hour turnaround, stem-level mixdowns, and streaming-ready masters for commercial releases.',
